...
class TextRank4Sentences():
    ...
    def analyze(self, text, stop_words=None, language='english'):
        self.text_str = text
        self.sentences = sent_tokenize(self.text_str, language)
...
with open('out.txt', 'w') as f:
    for name in glob.glob('articles/*'):
        ...
        tr4sh.analyze(file.read(), stop_words=stop_words, language="spanish")
        print(tr4sh.get_top_sentences(1), file=f)
